 ...
 * 0.14 는 가장 안전하지만 작은 화면에서 거의 검정으로 보여 3D 장면과 괴리가 컸다.
 * 색이 실제로 읽히면서도 실측 성공률이 급격히 꺾이기 전인 0.18 을 사용한다.
 * 넓은 quiet zone과 오류 정정 Q를 함께 적용해 판독 여유를 보완한다.
 */
export const DARK_GRAY = 0.18;
